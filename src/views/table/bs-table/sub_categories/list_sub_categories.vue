...
export default {
  ...
  mounted() {
    this.formValues.cat_id = this.$route.params.id
    this.getDocuments()
  },
  methods: {
    onClose() {
    ...
    deleteDocument(id) {
      ...
      this.$swal({
        ...
        if (result.value) {
          axios
            .get(`/groups/delete_sub_category/${id}`)
            .then(response => {
              if (response.data.hasOwnProperty('success')) {
                if (response.data.success === true) {
                  ...
                  this.$toast({
                    ...
                    position: 'top-right',
                    props: {
                      title: 'Sub Categories Deleted Successfully',
                      icon: 'EditIcon',
                      variant: 'success',
                    },
                  })
                  console.log('Sub Categories Deleted Successfully')
                } else {
                  this.$toast({
                    component: ToastificationContent,
                    position: 'top-right',
    ...
    getDocuments() {
      ...
      axios
        .get(`/groups/get_sub_categories/${this.formValues.cat_id}/${this.page}`)

        .then(response => {
          console.log('response', response.data.data)
          this.items = response.data.data.sub_category
