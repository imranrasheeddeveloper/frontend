...
export default {
  ...
  setup() {
    ...
    const taskFilters = [
      ...
      { title: 'My Completed', icon: 'CheckIcon', route: { name: 'apps-todo-filter', params: { filter: 'completed' } } },
      { title: 'Assinged By Me', icon: 'StarIcon', route: { name: 'apps-todo-filter', params: { filter: 'assingedByMe' } } },
      { title: 'Other Completed', icon: 'CheckIcon', route: { name: 'apps-todo-filter', params: { filter: 'otherCompleted' } } },
